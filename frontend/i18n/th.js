...
window.I18N_TH = {
  ...
  rpLoadingLong:'ช่วงย้อนหลังยาวใช้เวลาโหลดนานกว่าปกติ กรุณารอสักครู่…',
  rpTimeout:'โหลดข้อมูลนานเกินไป',
  rpTimeoutHint:'ลองเลือกช่วงให้สั้นลง หรือกดรีเฟรชอีกครั้ง (รอบถัดไปจะเร็วขึ้นเพราะระบบเก็บผลไว้แล้ว)',
